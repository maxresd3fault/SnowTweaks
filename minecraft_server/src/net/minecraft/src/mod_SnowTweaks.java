...
public class mod_SnowTweaks extends BaseModMp {
    ...
    public void ModsLoaded() {
        ...
        try {
        	...
        	bronzeSnowShovel = (new ItemSnowShovel(Integer.parseInt(bronzeSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setMaxDamage(350).setItemName("bronzeSnowShovelID");
