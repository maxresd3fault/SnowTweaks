...
public class mod_SnowTweaks extends NetworkMod {
	...
	public void load() {
		...
		try {
			...
			blockGhostSnow = (new BlockGhostSnow(Integer.parseInt(blockGhostSnowID.value), 180).a("blockGhostSnow"));
			ModLoader.registerBlock(blockGhostSnow);
			ModLoader.addName(blockGhostSnow, "Snow Won't Fall Here");
			
			woodSnowShovel = (new ItemSnowShovel(Integer.parseInt(woodSnowShovelID.value) - 256, EnumToolMaterial.WOOD)).a("woodSnowShovel");
			ModLoader.addRecipe(new ItemStack(woodSnowShovel, 1), new Object[] {"0W0", "WSW", "0S0", Character.valueOf('W'), Block.WOOD, Character.valueOf('S'), Item.STICK});
			ModLoader.addName(woodSnowShovel, "Wood Snow Shovel");
			emcVals.put(woodSnowShovel, 32);
			
			stoneSnowShovel = (new ItemSnowShovel(Integer.parseInt(stoneSnowShovelID.value) - 256, EnumToolMaterial.STONE)).a("stoneSnowShovel");
			...
			ironSnowShovel = (new ItemSnowShovel(Integer.parseInt(ironSnowShovelID.value) - 256, EnumToolMaterial.IRON)).a("ironSnowShovel");
			ModLoader.addRecipe(new ItemStack(ironSnowShovel, 1), new Object[] {"0I0", "ISI", "0S0", Character.valueOf('I'), Item.IRON_INGOT, Character.valueOf('S'), Item.STICK});
			ModLoader.addName(ironSnowShovel, "Iron Snow Shovel");
			emcVals.put(ironSnowShovel, 776);
			
			diamondSnowShovel = (new ItemSnowShovel(Integer.parseInt(diamondSnowShovelID.value) - 256, EnumToolMaterial.DIAMOND)).a("diamondSnowShovel");
			...
			goldSnowShovel = (new ItemSnowShovel(Integer.parseInt(goldSnowShovelID.value) - 256, EnumToolMaterial.GOLD)).a("goldSnowShovel");
			ModLoader.addRecipe(new ItemStack(goldSnowShovel, 1), new Object[] {"0G0", "GSG", "0S0", Character.valueOf('G'), Item.GOLD_INGOT, Character.valueOf('S'), Item.STICK});
			ModLoader.addName(goldSnowShovel, "Gold Snow Shovel");
			emcVals.put(goldSnowShovel, 6152);
			
			ModLoader.addShapelessRecipe(new ItemStack(Block.SNOW, 1), new Object[] {new ItemStack(Item.SNOW_BALL)});
			ModLoader.addShapelessRecipe(new ItemStack(Item.SNOW_BALL, 1), new Object[] {new ItemStack(Block.SNOW)});
			ModLoader.addShapelessRecipe(new ItemStack(Block.SNOW_BLOCK, 1), new Object[] {new ItemStack(Block.SNOW), new ItemStack(Block.SNOW), new ItemStack(Block.SNOW), new ItemStack(Block.SNOW)});
		} finally {
			config.save();
		}
	...
	public void modsLoaded() {
		...
		try { // IndustrialCraft Stuff
			...
			bronzeSnowShovel = (new ItemSnowShovel(Integer.parseInt(bronzeSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setMaxDurability(350).a("bronzeSnowShovel");
		...
		try { // RedPower Stuff
			Class<?> RedPowerBase = Class.forName("net.minecraft.server.RedPowerBase");
			redPowerFound = true;
			...
			rubySnowShovel = (new ItemSnowShovel(Integer.parseInt(rubySnowShovelID.value) - 256, EnumToolMaterial.IRON)).setMaxDurability(500).a("rubySnowShovel");
			...
			emeraldSnowShovel = (new ItemSnowShovel(Integer.parseInt(emeraldSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setMaxDurability(500).a("emeraldSnowShovel");
			...
			sapphireSnowShovel = (new ItemSnowShovel(Integer.parseInt(sapphireSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setMaxDurability(500).a("sapphireSnowShovel");
		...
		try { // EE Stuff
			...
			for (Map.Entry<Item, Integer> entry : emcVals.entrySet()) {
				...
				addEMC.invoke(null, item.id, 0, value);
			}
	...
	public boolean onTickInGame(MinecraftServer server) {
		if (!isLoaded && (!doesSnowMelt || !doesIceMelt)) {
			SnowTweaksOverrides.injectSnowTweaks(server.getWorldServer(0));
			isLoaded = true;
		}
		return true;
	}
	...
	public static MovingObjectPosition rayTrace(EntityLiving player, double reach, float partialTicks) {
		Vec3D eyePosition = Vec3D.create(player.locX, player.locY + player.getHeadHeight(), player.locZ);
		Vec3D lookDirection = player.f(partialTicks);
		Vec3D rayEnd = eyePosition.add(lookDirection.a * reach, lookDirection.b * reach, lookDirection.c * reach);
		return player.world.rayTrace(eyePosition, rayEnd, true);
	}
