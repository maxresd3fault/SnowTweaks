...
public class mod_SnowTweaks extends NetworkMod {
	...
	public void modsLoaded() {
		...
		try { // RedPower Stuff
			...
			rubySnowShovel = (new ItemSnowShovel(Integer.parseInt(rubySnowShovelID.value) - 256, EnumToolMaterial.IRON)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/maxres/SnowTweaks/rubySnowShovel.png")).setMaxDamage(500).setItemName("rubySnowShovel");
			...
			emeraldSnowShovel = (new ItemSnowShovel(Integer.parseInt(emeraldSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/maxres/SnowTweaks/emeraldSnowShovel.png")).setMaxDamage(500).setItemName("emeraldSnowShovel");
			...
			sapphireSnowShovel = (new ItemSnowShovel(Integer.parseInt(sapphireSnowShovelID.value) - 256, EnumToolMaterial.IRON)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/maxres/SnowTweaks/sapphireSnowShovel.png")).setMaxDamage(500).setItemName("sapphireSnowShovel");
	...
	@Override
	public boolean onTickInGame(float f, Minecraft client) {
		if (!client.theWorld.isRemote && (!doesSnowMelt || !doesIceMelt) && (lastWorld != client.theWorld)) {
			SnowTweaksOverrides.injectSnowTweaks(client.theWorld);
