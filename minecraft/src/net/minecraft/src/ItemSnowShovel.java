		...
		if (mop != null && mop.typeOfHit == EnumMovingObjectType.TILE) {
			...
			if (block != null && block.blockID == Block.snow.blockID) {
				...
				if (!world.isRemote) {
					...
					world.joinEntityInSurroundings(var15);
				}
				world.playSoundEffect(x + 0.5, y + 0.5, z + 0.5, Block.snow.stepSound.getBreakSound(), (Block.snow.stepSound.getVolume() + 1.0F) / 2.0F, Block.snow.stepSound.getPitch() * 0.8F);
			}
		}
